                ...
                <div class="col-12 col-md-12 col-lg-12 text-center" data-aos="fade-left">
                    ...
                    <div id="content">
                        ...
                        <p class="section-desc">At Jagannath Vidyalaya Matriculation Higher Secondary School, Thandalam,
                            Thiruporur, we believe every child has the potential to achieve excellence. Our school
                            provides a safe, inspiring, and supportive learning environment where students develop
                            academic knowledge, strong values, creativity, confidence, and essential life skills to
                            succeed in a rapidly changing world.</p>
                        <p class="section-desc">Since our establishment in 2022, Jagannath Vidyalaya has been committed
                            to nurturing intellectual curiosity, critical thinking, and a lifelong passion for learning.
                            Our well-structured academic programs inspire students to achieve excellence, build
                            confidence, strengthen problem-solving skills, and prepare them for higher education and
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg-6 align-content-center" data-aos="fade-left">
                    <p class="section-desc">At Jagannath Vidyalaya MHSS, we offer a structured and progressive
                        curriculum designed to build a strong academic foundation while fostering intellectual and
                        personal growth. Our course structure ensures conceptual clarity,critical thinking, and skill
                        development at every level.</p>
                </div>
            </div>
                ...
                <div class="col-12 col-md-8 col-lg-8">
                    <div class="accordion-group">
                        <details class="acc-item">
                            ...
                            <div class="content-wrapper">
                                <div class="content-body">
                                    <p>The early childhood curriculum is designed to provide a *play-based, interactive,
                                        and engaging learning environment that stimulates curiosity and creativity in
                                        young minds.</p>
                                    ...
                                    <ul class="icon-list">
                                        ...
                                        <li class="list">Activity-Based Learning: Storytelling, Rhymes, Art & Craft,
                                            Physical Development Activities</li>
                                    </ul>
                                </div>
                            </div>
                        </details>
                        <details class="acc-item">
                            ...
                            <div class="content-wrapper">
                                <div class="content-body">
                                    <p>Our primary curriculum introduces students to core academic subjects while also
                                        emphasizing language development, values, and general knowledge.</p>
                                    <h5>Subject Offered</h5>
                                    <ul class="icon-list">
                                        <li class="list">Core Subjects: Tamil, English, Mathematics, Environmental
                                            Studies (EVS)</li>
                                        <li class="list">Non-Core Subjects: Computer Science (C.Sc), General Knowledge
                                            (GK), Value Education (VE), Hindi</li>
                                    </ul>
                                    <p>The curriculum focuses on interactive learning, hands-on activities, and
                                        foundational literacy and numeracy skills.</p>
                                </div>
                            </div>
                        </details>
                        <details class="acc-item">
                            ...
                            <div class="content-wrapper">
                                <div class="content-body">
                                    <p>Students are introduced to a broader and more detailed curriculum that encourages
                                        analytical thinking, problem-solving, and subject specialization.</p>
                                    <h5>Subject Offered</h5>
                                    <ul class="icon-list">
                                        <li class="list">Core Subjects: Tamil, English, Mathematics, Science, Social
                                            Science</li>
                                        <li class="list">Non-Core Subjects: Computer Science (C.Sc), General Knowledge
                                            (GK), Value Education (VE), Hindi</li>
                                    </ul>
                                    <p>The curriculum integrates experiential learning, project-based assignments, and
                                        technology-driven education.</p>
                                </div>
                            </div>
                        </details>
                        <details class="acc-item">
                            ...
                            <div class="content-wrapper">
                                <div class="content-body">
                                    <p>The curriculum at this level is designed to prepare students for board
                                        examinations while also focusing on skill development and career readiness.</p>
                                    <h5>Subject Offered</h5>
                                    <ul class="icon-list">
                                        <li class="list">Core Subjects: Tamil, English, Mathematics, Science, Social
                                            Science</li>
                                    ...
                                    <p>Special focus is given to exam preparation, conceptual clarity, and
                                        application-based learning.</p>
                                </div>
                            </div>
                        </details>
                        <details class="acc-item">
                            ...
                            <div class="content-wrapper">
                                <div class="content-body">
                                    <p>Students choose Science or Commerce streams based on their interests and career
                                        goals, building a strong foundation for higher education and success.</p>
                                    <h5>Subject Offered</h5>
                                    <ul class="icon-list">
    ...
    <div class="container">
        ...
        <div class="gallery-grid">
            ...
            <div class="gallery-img tall" data-aos="fade-right">
                <img src="Assets/Images/gallery-new-1.webp" alt="" class="img-fluid">
                <div class="overlay">
                    <div class="icon-circle" data-bs-toggle="modal" data-bs-target="#gModal" data-img="Assets/Images/gallery-new-1.webp">
                        <svg xmlns="http://www.w3.org/2000/svg" height="24" width="24" viewBox="0 -960 960 960" fill="#010f51">
            ...
            <div class="gallery-img" id="image-2" data-aos="fade-down">
                <img src="Assets/Images/gallery-new-2.webp" alt="" class="img-fluid">
                <div class="overlay">
                    <div class="icon-circle" data-bs-toggle="modal" data-bs-target="#gModal" data-img="Assets/Images/gallery-new-2.webp">
                        <svg xmlns="http://www.w3.org/2000/svg" height="24" width="24" viewBox="0 -960 960 960" fill="#010f51">
                            <path d="M607.5-372.5Q660-425 660-500t-52.5-127.5Q555-680 480-680t-127.5 52.5Q300-575 300-500t52.5 127.5Q405-320 480-320t127.5-52.5Zm-204-51Q372-455 372-500t31.5-76.5Q435-608 480-608t76.5 31.5Q588-545 588-500t-31.5 76.5Q525-392 480-392t-76.5-31.5ZM214-281.5Q94-363 40-500q54-137 174-218.5T480-800q146 0 266 81.5T920-500q-54 137-174 218.5T480-200q-146 0-266-81.5Z" />
                        </svg>
                    </div>
            ...
            <div class="gallery-img" data-aos="fade-down">
                <img src="Assets/Images/gallery-new-3.webp" alt="" class="img-fluid">
                <div class="overlay">
                    <div class="icon-circle" data-bs-toggle="modal" data-bs-target="#gModal" data-img="Assets/Images/gallery-new-3.webp">
                        <svg xmlns="http://www.w3.org/2000/svg" height="24" width="24" viewBox="0 -960 960 960" fill="#010f51">
                            <path d="M607.5-372.5Q660-425 660-500t-52.5-127.5Q555-680 480-680t-127.5 52.5Q300-575 300-500t52.5 127.5Q405-320 480-320t127.5-52.5Zm-204-51Q372-455 372-500t31.5-76.5Q435-608 480-608t76.5 31.5Q588-545 588-500t-31.5 76.5Q525-392 480-392t-76.5-31.5ZM214-281.5Q94-363 40-500q54-137 174-218.5T480-800q146 0 266 81.5T920-500q-54 137-174 218.5T480-200q-146 0-266-81.5Z" />
                        </svg>
                    </div>
            ...
            <div class="gallery-img" data-aos="fade-left">
                <img src="Assets/Images/gallery-new-4.webp" alt="" class="img-fluid">
                <div class="overlay">
                    <div class="icon-circle" data-bs-toggle="modal" data-bs-target="#gModal" data-img="Assets/Images/gallery-new-4.webp">
                        <svg xmlns="http://www.w3.org/2000/svg" height="24" width="24" viewBox="0 -960 960 960" fill="#010f51">
                            <path d="M607.5-372.5Q660-425 660-500t-52.5-127.5Q555-680 480-680t-127.5 52.5Q300-575 300-500t52.5 127.5Q405-320 480-320t127.5-52.5Zm-204-51Q372-455 372-500t31.5-76.5Q435-608 480-608t76.5 31.5Q588-545 588-500t-31.5 76.5Q525-392 480-392t-76.5-31.5ZM214-281.5Q94-363 40-500q54-137 174-218.5T480-800q146 0 266 81.5T920-500q-54 137-174 218.5T480-200q-146 0-266-81.5Z" />
                        </svg>
                    </div>
            ...
            <!-- Bottom row: images 5, 6, 7 -->
            <div class="gallery-img" data-aos="fade-up">
                <img src="Assets/Images/gallery-new-5.webp" alt="" class="img-fluid">
                <div class="overlay">
                    <div class="icon-circle" data-bs-toggle="modal" data-bs-target="#gModal" data-img="Assets/Images/gallery-new-5.webp">
                        <svg xmlns="http://www.w3.org/2000/svg" height="24" width="24" viewBox="0 -960 960 960" fill="#010f51">
                            <path d="M607.5-372.5Q660-425 660-500t-52.5-127.5Q555-680 480-680t-127.5 52.5Q300-575 300-500t52.5 127.5Q405-320 480-320t127.5-52.5Zm-204-51Q372-455 372-500t31.5-76.5Q435-608 480-608t76.5 31.5Q588-545 588-500t-31.5 76.5Q525-392 480-392t-76.5-31.5ZM214-281.5Q94-363 40-500q54-137 174-218.5T480-800q146 0 266 81.5T920-500q-54 137-174 218.5T480-200q-146 0-266-81.5Z" />
                        </svg>
                    </div>
            ...
            <div class="gallery-img" data-aos="fade-up">
                <img src="Assets/Images/gallery-new-6.webp" alt="" class="img-fluid">
                <div class="overlay">
                    <div class="icon-circle" data-bs-toggle="modal" data-bs-target="#gModal" data-img="Assets/Images/gallery-new-6.webp">
                        <svg xmlns="http://www.w3.org/2000/svg" height="24" width="24" viewBox="0 -960 960 960" fill="#010f51">
                            <path d="M607.5-372.5Q660-425 660-500t-52.5-127.5Q555-680 480-680t-127.5 52.5Q300-575 300-500t52.5 127.5Q405-320 480-320t127.5-52.5Zm-204-51Q372-455 372-500t31.5-76.5Q435-608 480-608t76.5 31.5Q588-545 588-500t-31.5 76.5Q525-392 480-392t-76.5-31.5ZM214-281.5Q94-363 40-500q54-137 174-218.5T480-800q146 0 266 81.5T920-500q-54 137-174 218.5T480-200q-146 0-266-81.5Z" />
                        </svg>
                    </div>
            ...
            <!-- NOTE: this design needs a 7th image asset that wasn't in your original markup -->
            <div class="gallery-img" data-aos="fade-left">
                <img src="Assets/Images/gallery-new-7.webp" alt="" class="img-fluid">
                <div class="overlay">
                    <div class="icon-circle" data-bs-toggle="modal" data-bs-target="#gModal" data-img="Assets/Images/gallery-new-7.webp">
                        <svg xmlns="http://www.w3.org/2000/svg" height="24" width="24" viewBox="0 -960 960 960" fill="#010f51">
                            <path d="M607.5-372.5Q660-425 660-500t-52.5-127.5Q555-680 480-680t-127.5 52.5Q300-575 300-500t52.5 127.5Q405-320 480-320t127.5-52.5Zm-204-51Q372-455 372-500t31.5-76.5Q435-608 480-608t76.5 31.5Q588-545 588-500t-31.5 76.5Q525-392 480-392t-76.5-31.5ZM214-281.5Q94-363 40-500q54-137 174-218.5T480-800q146 0 266 81.5T920-500q-54 137-174 218.5T480-200q-146 0-266-81.5Z" />
                        </svg>
                    </div>
    ...
    <div class="modal fade" id="gModal" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content bg-transparent border-0">
                ...
                <img id="popupImage" src="" class="img-fluid rounded-3" alt="Gallery">
