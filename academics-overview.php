...
<head>
    ...
    <title>Academics Overview - Jagannath Vidyalaya Matriculation Higher Secondary School</title>
                ...
                <div class="col-12 col-md-6 col-lg-6 mb-4 mb-lg-0" data-aos="fade-right">
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-6">
                            ...
                            <p>Our teaching methodology blends traditional values with modern practices to create an engaging learning environment. Through activity-based learning, smart classrooms, projects, digital tools and interactive lessons, we develop critical thinking, creativity communication, and problem-solving.</p>
                        </div>
                    </div>
                ...
                <div class="col-12 col-md-6 col-lg-6 mb-4 mb-lg-0" data-aos="fade-left">
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-6">
                            ...
                            <p>Assessment at Jagannath Vidyalaya follows a continuous and comprehensive approach to measure academic progress and overall development. Through tests, examinations, projects, practicals, and classroom observation, we assess conceptual understanding, creativity, communication, and application.</p>
                        </div>
                    </div>
                ...
                <div class="col-12 col-md-6 col-lg-6 mb-4 mb-lg-0" data-aos="fade-right" data-aos-delay="100">
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-6">
                            ...
                            <p>Value Education is an integral part of our curriculum, nurturing discipline, integrity, empathy, respect, and responsibility. Through classroom activities, real-life experiences, and value-based learning, students develop strong character, positive attitudes, social awareness, and compassion for others.</p>
                        </div>
                    </div>
                ...
                <div class="col-12 col-md-6 col-lg-6 mb-4 mb-lg-0" data-aos="fade-left" data-aos-delay="100">
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-6">
                            ...
                            <p>The Academic Calendar outlines the complete schedule for the academic year, including reopening dates, examinations, holidays, school events, Parent-Teacher Meetings, and important activities. It helps students and parents stay informed, organized, and prepared throughout the academic year.</p>
                        </div>
                    </div>
